...
1. **Фаза 0: Планирование** (если еще не завершена)
   ...
   - Создавать план выполнения в `.qwen/specify/specs/{ID}/plans/plans/research-data-analysis-plan.json`

2. **Фаза 1-N: Выполнение фаз**
   - Обновлять TodoWrite (в_процессе)
   - Создавать файл плана (`.qwen/specify/specs/{ID}/plans/plans/research-data-analysis-plan.json`)
