...
1. **Фаза 0: Планирование** (если еще не завершена)
   ...
   - Создавать план выполнения в `.tmp/current/plans/testing-quality-assurance-plan.json`

2. **Фаза 1-N: Выполнение фаз**
   - Обновлять TodoWrite (в_процессе)
   - Создавать файл плана (`.tmp/current/plans/testing-quality-assurance-plan.json`)
