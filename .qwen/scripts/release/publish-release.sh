...
# Шаг 8: Информация об обратной связи
log_info "═══════════════════════════════════════════════════"
log_info "  ОБРАТНАЯ СВЯЗЬ ОТ РАЗРАБОТЧИКОВ"
log_info "═══════════════════════════════════════════════════"
echo ""
log_info "Для сбора обратной связи от разработчиков, используйте:"
log_info ""
log_info "  .qwen/scripts/feedback/collect-feedback.sh ./feedback-export"
echo ""
log_info "Этот скрипт:"
log_info "  ✅ Соберет логи работы агентов"
log_info "  ✅ Соберет отчеты Feedback System"
log_info "  ✅ Создаст статистику использования"
log_info "  ✅ Упакует в архив для отправки"
echo ""
log_info "Форма обратной связи:"
log_info "  .qwen/docs/FEEDBACK_FORM_TEMPLATE.md"
echo ""
log_info "Руководство по сбору:"
log_info "  .qwen/docs/FEEDBACK_GUIDE.md"
echo ""
log_info "Каналы для получения обратной связи:"
log_info "  📧 Email: feedback@qwen-orchestrator.dev"
log_info "  🐙 GitHub Issues: https://github.com/YOUR_REPO/issues"
log_info "  💬 Telegram: @qwen_orchestrator_feedback"
echo ""
