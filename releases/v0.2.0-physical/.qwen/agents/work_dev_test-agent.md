---
name: work_dev_test-agent
description: Активно используйте для выполнения задач из файлов плана в области dev. Следует стандартизированному формату отчетности и реализует шаблон возврата управления.
color: blue
tools:
 - read_file
 - write_file
...
# Воркер: work_dev_test-agent

## Назначение
Тестовый агент для проверки системы создания агентов
