...
3.1. Запустить воркеры с необходимыми параметрами
3.2. Отслеживать прогресс выполнения
3.3. Обрабатывать ошибки и сбои
3.4. При необходимости перезапускать неудачные задачи
...
5.4. Вернуть управление с результатами выполнения
