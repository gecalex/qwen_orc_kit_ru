...
case $project_state in
    ...
    "existing_code_no_specs")
        ...
        echo "2. Создать реверс-инжиниринг спецификации"
    ...
    "full_specification")
        ...
        ;;
    *)
        echo "Неопределенное состояние проекта. Требуется ручной анализ."
        ;;
esac

# Возвращаем код состояния для использования в других скриптах
case $project_state in
    "empty") exit 10 ;;
    "existing_code_no_specs") exit 20 ;;
    "partial_specification") exit 30 ;;
    "full_specification") exit 40 ;;
    *) exit 0 ;;
esac
